  ...
  return (
    <>
      ...
      <div className="p-6 lg:justify-center lg:p-8 flex min-h-screen flex-col items-center bg-[#FDFDFC] text-[#1b1b18] dark:bg-[#0a0a0a]">
        <header className="mb-6 text-sm lg:max-w-4xl w-full max-w-[335px] not-has-[nav]:hidden">
          <nav className="gap-4 flex items-center justify-end">
            {auth.user ? (
              <Link
                href={route('dashboard')}
                className="rounded-sm px-5 py-1.5 text-sm leading-normal inline-block border border-[#19140035] text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]"
              >
                Dashboard
              </Link>
            ) : (
              <>
                <Link
                  href={route('login')}
                  className="rounded-sm px-5 py-1.5 text-sm leading-normal inline-block border border-transparent text-[#1b1b18] hover:border-[#19140035] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]"
                >
                  Log in
                </Link>
                <Link
        ...
        <div className="lg:grow flex w-full items-center justify-center opacity-100 transition-opacity duration-750 starting:opacity-0">
          <main className="lg:max-w-4xl lg:flex-row flex w-full max-w-[335px] flex-col-reverse">
            ...
            <div className="rounded-t-lg lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden bg-[#fff2f2] dark:bg-[#1D0002]">
              <svg
                className="translate-y-0 starting:translate-y-6 w-full max-w-none text-[#F53003] opacity-100 transition-all duration-750 dark:text-[#F61500] starting:opacity-0"
                viewBox="0 0 438 104"
                fill="none"
              ...
              <svg
                className="-ml-8 lg:-mt-[6.6rem] lg:ml-0 relative -mt-[4.9rem] w-[448px] max-w-none dark:hidden"
                viewBox="0 0 440 376"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <g className="translate-y-0 starting:translate-y-4 opacity-100 transition-all delay-300 duration-750 starting:opacity-0">
                  <path
                ...
                <g
                  ...
                  className="translate-y-0 starting:translate-y-4 opacity-100 transition-all delay-300 duration-750 starting:opacity-0"
                >
                  <path
              ...
              <svg
                className="-ml-8 lg:-mt-[6.6rem] lg:ml-0 relative -mt-[4.9rem] hidden w-[448px] max-w-none dark:block"
                viewBox="0 0 440 376"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <div className="inset-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg absolute shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]" />
            </div>
          </main>
        </div>
        <div className="h-14.5 lg:block hidden"></div>
      </div>
    </>
  );
}
